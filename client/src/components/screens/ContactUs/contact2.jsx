                            ...
                            <h2 className="py-4">Get In Touch</h2>
                                <form onSubmit={(e) => handleSubmit(e)}>
                                    <div className="form-group">
                                        <input placeholder="Name" value={name} onChange={handleName} type="text" className="form-control  " required />
                                    </div>
                                    <div className="form-group">
                                        <input placeholder="Email" value={email} onChange={handleEmail} type="email" className="form-control" required />
                                    </div>
                                    <div className="form-group">
                                        <textarea placeholder="Enter Message Here" value={message} onChange={handleMessage} cols="50" rows="20" className="form-control"></textarea>
                                    </div>
